...
Future<String?> uplodFirebaseImageCategoryService(Uint8List image) async {
...
Future<String?> uplodFirebaseImageCourseService(Uint8List image) async {
  log("image service start to try");
